        ...
        module.factory('authInterceptor', function($q) {
            return {
                request: function (config) {
                    ...
                    if (!config.headers.Authorization && !config.params.access_token) {
...
module.controller('GlobalCtrl', function($scope, $http, $location, Auth) {
    ...
    $scope.loadSocialProfile = function() {
        $http.get('/auth/realms/microsoft-identity-provider-realm/broker/microsoft/token').success(function(data) {
